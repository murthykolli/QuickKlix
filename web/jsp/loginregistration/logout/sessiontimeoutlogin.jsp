<%-- 
    Document   : sessiontimeoutlogin
    Created on : 17 Jun, 2014, 2:46:24 PM
    Author     : murthyk
--%>
...
<body class="body_page">
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 580px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div id="errMsgId" style="margin-left: 100px;margin-top: 150px;position:absolute;font: 0.95em/1.25em sans-serif;color:#00a9f1;">Your session has expired.</div>
