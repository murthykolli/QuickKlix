<%-- 
    Document   : radio_Data_Saving
    Created on : 16 Jul, 2014, 11:49:23 AM
    Author     : anusha
--%>
...
//      element.innerHTML = pagerHtml;
        ...
        function changeColor(chk) {
            if (chk.checked == true || document.radio.combinationalName[chk].checked == true) {
                var i;
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Radio</font></div><br/>
     ...
     <div style=" min-height: 250px;">
      ...
      <s:form  action="manageRadioSaving" name="radio" id="radio">

               <table> <tr> <td width="880" align="right">
                 <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total radio stations&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
               </td> </tr> </table>
              ...
              <div style="margin-left: 0px;width: 902px;margin-top: -15px;">
                ...
                <display:table  id="insured_list"  class="tablesorter" name="radioListTakeFromDB" style="width:860px;">
                    <display:column headerClass="sortDisabled">
                        <input type="radio" style="cursor: pointer;" onclick="changeColor(this);" name="combinationalName" value="${insured_list.npMediaIds}">
                    </display:column>
            ...
            function deleteForm(){
                ...
                for(var k=0; k < document.radio.combinationalName.length; k++)
                {
                    if(document.radio.combinationalName[k].checked){
                        mediaName=document.radio.combinationalName[k].value;
                    }
                }
                if(document.radio.combinationalName.checked){
                    mediaName=document.radio.combinationalName.value;
                  }
                if(mediaName != ""){
                    var where_to= confirm("Do you want to delete the Radio Station(s)?");
                    if (where_to)
                    {
                        return true;
                    }
