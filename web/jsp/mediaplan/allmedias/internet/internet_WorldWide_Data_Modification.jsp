<%-- 
    Document   : internet_WorldWide_Data_Modification
    Created on : 23 Jul, 2014, 11:51:50 AM
    Author     : anusha
--%>
...
<html>
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Top Internet Sites in the World by Rank</font></font></div><br>
  <div style="margin-left:20px;">
  <s:form id="internet" name="internet" action="worldWideInternetSitesModification">

      <table border="0" width="870" style="margin-left: 30px;">
          <tr>
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total&nbsp;selected&nbsp;internet&nbsp;sites&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="worldWideInternetModifyContactInfo" style="width:890px;">
      ...
      <div align="center" style="margin-top: 50px;margin-left: 200px;">
          ...
          <table style="margin-left: 565px;margin-top: -10px;position: absolute">
              <tr><td><button type="submit" name="method:internetWorldWideModification" onclick="return websiteSelection();" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" alt="SAVE"/> <font style="top: -3px;position: relative;">SAVE</font></button></td></tr>
          </table>
      </div>
