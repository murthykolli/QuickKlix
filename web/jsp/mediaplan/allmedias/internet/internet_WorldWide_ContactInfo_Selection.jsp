<%-- 
    Document   : internet_WorldWide_ContactInfo_Selection
    Created on : 23 Jul, 2014, 10:27:31 AM
    Author     : anusha
--%>
...
<html>
  ...
  <s:form id="internet" name="internet" action="worldTopSitesContactInfoSaving">
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="worldWideInternetContactInfo" style="width:890px;">
      ...
      <div align="center" style="margin-top: 50px;margin-left: 200px;">
          ...
          <table style="margin-left: 565px;margin-top: -10px;position: absolute">
              <tr><td><button type="submit" name="method:internetWorldWideSaving" onclick="return websiteSelection();" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" alt="SAVE"/> <font style="top: -3px;position: relative;">SAVE</font></button></td></tr>
          </table>
      </div>
