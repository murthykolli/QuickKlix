...
//    element.innerHTML = pagerHtml;
    ...
    if (chk.checked == true || document.mAppsFormName.combinationalName[chk].checked == true) {
    var i;
    ...
    <body class="body_page">
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Mobile Apps</font></div><br/>
     ...
     <div style=" min-height: 250px;">
      <s:form  action="mobileAppsManagement" name="mAppsFormName" id="mAppsFormName">
        <table> <tr> <td width="880px" align="right">
        <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1"> Total mobile apps&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
        </td> </tr> </table>
        ...
        <display:table  id="insured_list"  class="tablesorter" name="mobileAppDataListTakeFromDB" style="width:860px;">
           ...
           <display:column  property ="newspaperName" title="Media Name" style="white-space:normal;width:440px;float: left;text-align: justify;"/>
   ...
   <br/><br/><br/><br/><br/><br/>
    ...
    function deleteForm(){
    if(document.mAppsFormName.combinationalName.checked == true){
    var where_to= confirm("Do you want to delete the Mobile App(s)?");
    if (where_to){
    return true;
    }
    else{
