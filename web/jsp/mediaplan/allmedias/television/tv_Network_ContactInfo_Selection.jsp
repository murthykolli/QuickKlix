<%-- 
    Document   : tv_Network_ContactInfo_Selection
    Created on : 30 Jul, 2014, 12:41:09 PM
    Author     : murthyk
--%>
...
<html>
  ...
  <s:form id="television" name="television" action="tvNetworkContactInfoSaving">
      ...
      <div align="center" style="margin-top: 50px;margin-left: 200px;">
         ...
         <table style="margin-left: 565px;margin-top: -10px;position: absolute">
             <tr><td><button type="submit" name="method:televisionSaving" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"  onclick="return televisionSelection();"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" /> <font style="top: -3px;position: relative;">SAVE</font></button></td></tr>
         </table>
      </div>
     </s:form>
   <script>
      ...
      function televisionSelection(){
        ...
        selectedNewspaper=document.television.combinationalName[k].value;
        }
        }
        if(document.television.combinationalName.checked){
         selectedNewspaper=document.television.combinationalName.value;
         }
