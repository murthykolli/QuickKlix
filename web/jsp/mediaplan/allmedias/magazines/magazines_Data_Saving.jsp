<%-- 
    Document   : magazines_Data_Saving
...
//        element.innerHTML = pagerHtml;
        ...
        function changeColor(chk) {
            if (chk.checked == true || document.magazine.categoryBasedMagazine[chk].checked == true) {
                var i;
        ...
        function highlightTableRows(tableId) {
            ...
            for (var i = 1; i < rows.length; i++) {
                rows[i].onmouseover = function() {
                    ...
                    var cell = row.getElementsByTagName('td');
                    if ((rows.length == 2 && document.magazine.categoryBasedMagazine.checked == false) || (document.magazine.categoryBasedMagazine[j - 1].checked == false)) {
                ...
                rows[i].onclick = function() {
                    ...
                    if (rows.length == 2) {
                        ...
                        document.magazine.categoryBasedMagazine[l - 1].checked = true;
                        changeColor(l - 1);
                    } }; } }
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Magazines</font></div><br/>
        ...
        <table style="margin-left: 24px;margin-top:31px;position: absolute;">
            <tr><tr><td id="AllMediasRedirectionId" style="display: none;border-bottom: 27px solid #f1f1f1;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="allMediasDataSaving.action" title="All Medias" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="#6f6e6e" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='#6f6e6e';" ><b>&nbsp;All Medias&nbsp;</b></font></a> </td>
                ...
                <td style="border-bottom: 27px solid #7e7e7e;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="magazinesRedirection.action" title="Magazines" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="white" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='white';" ><b>&nbsp;Magazines&nbsp;</b></font></a> </td>
     ...
     <s:form name="magazine" action="manageMagazinesSaving" id="magazine">


                <table> <tr> <td width="880px" align="right">
                 <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total Magazines&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
               </td> </tr> </table>
              ...
              <div style="margin-left: 0px;width: 902px;margin-top: -15px;">
                <div style="margin-left: 20px;width:860px;overflow-x: auto;overflow: auto; overflow-y:hidden;white-space:nowrap;text-overflow:ellipsis;display:inline-block;">
                    ...
                    <display:table  id="insured_list" class="tablesorter" name="mgManageMedia" style="width:860px">
                    <display:column headerClass="sortDisabled">
                    <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="categoryBasedMagazine" value="${insured_list.npMediaIds}"/>
                    </display:column>                        
                    <display:column property ="mediaPlanName" title="Media Plan Name"/>
                    <display:column property ="mediaType" title="Media Type"/>
                    <display:column property ="selectedCategory" title="Media Name" style="white-space:normal;width:440px;float: left;text-align: justify;" />
        ...
        var count=<s:property value="mgCount"/>;
       ...
       var radList = document.getElementsByName("categoryBasedMagazine");
       for (var i = 0; i < radList.length; i++) {
       if(radList[i].checked) radList[i].checked = false;
       }
       var form=document.getElementById("magazine");
       if(count=="0"){
            ...
            function deleteForm(){
                ...
                for(var k=0; k < document.magazine.categoryBasedMagazine.length; k++)
                {
                    if(document.magazine.categoryBasedMagazine[k].checked){
                        newspaperNames=document.magazine.categoryBasedMagazine[k].value;
                    }
                }
                if(document.magazine.categoryBasedMagazine.checked){
                    newspaperNames=document.magazine.categoryBasedMagazine.value;
                  }newspaperNames=newspaperNames.split(",&,")
                if(newspaperNames != ""){
                    var where_to= confirm("Do you want to delete the Magazine(s)?");
                    if (where_to)
                    {
                        return true;
                    }
