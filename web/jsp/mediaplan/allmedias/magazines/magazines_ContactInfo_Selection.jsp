<%--
    Document   : magazines_ContactInfo_Selection
...
<html>
  ...
  <s:form  action="mgContactInfoSaving" name="magazineFormName" id="magazineFormId">
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="selectedMagazineContactInfo">
                    <display:column headerClass="sortDisabled"  title="<input type='checkbox' style='cursor: pointer;margin-left:20px;'  id='selectall' name='selectall' onClick='selectAllCheckBoxes(this)'/>" media="html">
