<%-- 
    Document   : magazines_Data_Modification
    Created on : 21 Jul, 2014, 4:11:10 PM
    Author     : murthyk
--%>
...
<html>
    ...
    this.showPageNav = function(pagerName, positionId) {
     ...
     var element = document.getElementById(positionId);
      var pagerHtml ='<table border="0" id="navigation" align="left"> <tr><td align="left" width="130">';
        ...
        var cell = row.getElementsByTagName('td');
        if(document.magazineFormName.combinationalName.checked == false){              
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "#00a9f1";
        cell[k].style.color = "white";
        }        
        document.magazineFormName.combinationalName.checked = true;
        } else{
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "";
        cell[k].style.color = "black";
        }
        document.magazineFormName.combinationalName.checked = false;    
        } }
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Magazines</font></font></div><br/>
  <div style="margin-left:20px;">
  <s:form id="magazineFormId" name="magazineFormName" action="magazinesModification">

     <table border="0" style="margin-left: 30px;width: 870px;">
          <tr>
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total&nbsp;selected magazines&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="selectedMagazineContactInfo" style="width:890px;">
      ...
      <div align="center" style="margin-top: 50px;">
         ...
         <table style="margin-left: 760px;margin-top: -10px;position: absolute">
             <tr><td><button type="submit" name="method:magazinesModification" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 36px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;" onclick="return magazineSelection();"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" style="position: relative;top: 1px;" /> <font style="top: -2px;position: relative;">SAVE</font></button></td></tr>
         </table>
         </div>
        ...
        function magazineSelection(){
         ...
         for(var k=0; k < document.magazineFormName.combinationalName.length; k++)
          ...
          if(document.magazineFormName.combinationalName[k].checked){
           selectedMagazine=document.magazineFormName.combinationalName[k].value;
          }
        }
        if(document.magazineFormName.combinationalName.checked){
         selectedMagazine=document.magazineFormName.combinationalName.value;
         }
         if(selectedMagazine == ""){
