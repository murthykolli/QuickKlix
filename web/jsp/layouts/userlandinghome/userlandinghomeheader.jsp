<%-- 
    Document   : userlandinghomeheader
    Created on : 3 Jun, 2014, 2:59:19 PM
    Author     : murthyk
--%>
...
<body>
    ...
    <div id="quickklix_banner"  align="left">
        ...
        <table style="position: relative;">
            <tr><td><b><font style="color:#00a9f1;font: bold 1em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;">Welcome&nbsp;&nbsp;<font color="#222222"><s:property value="loginUserFirstName"/>&nbsp;<s:property value="userLastName"/></font></font></b></td><td><font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>
    ...
    <div id="header">
    <ul>
    <li><a href="userLandingHome.action" class="current"> HOME</a>
