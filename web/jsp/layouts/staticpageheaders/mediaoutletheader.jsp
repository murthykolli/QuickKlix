<%-- 
    Document   : mediaoutletheader
    Created on : 18 Feb, 2014, 5:54:00 PM
    Author     : murthyk
--%>
...
<body>
    ...
    <li><a href="mediaoutletPage.action" class="current">MEMBERS</a></li>
    <li><a href="contactusPage.action">CONTACT US</a></li>
    <li><a href="quickklixLogin.action">LOGIN</a></li>
    </ul>
    </div>
    </div></div>
