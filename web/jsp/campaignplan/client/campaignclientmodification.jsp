<%-- 
    Document   : campaignclientmodification
    Created on : 16 Jun, 2014, 1:09:53 PM
    Author     : murthyk
--%>
       ...
       <script>
          window.onload=function(){
           ...
           function validation(){
            ...
            var clientName=document.clientFormName.clientName.value;
  ...
  function numeralsOnly(evt) {
   ...
   return true;
      ...
      <script type="text/javascript" language="javascript">
        ...
        if(document.clientFormName.clientName.value != ''){
        var clientsName = document.clientFormName.clientName.value;
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 520px;height: auto;border-radius: 30px 30px 0 0;"><br/>
     ...
     <div style="margin-top:-38px;margin-left: 14px;position: absolute;"><font style="font: bold 1.6em/1em Cambria;color: white;">New Client</font></div>
            ...
            <form action="campaignClientModificationSaving" name="clientFormName" id="clientFormId">
            <div style="margin-left: 10px;"><br/>
             <table style="margin-left: 25px;margin-top:13px;">
              <tr class="label"><td id="clientnamelabel" align="right">Client Name*:</td><td> <input type="text"  name="clientName" style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;"  maxlength="30" onblur="clientNameValidation();" onkeyup = "CheckFirstChar(event.keyCode, this);clientNameValidation();" onkeydown = "return CheckFirstChar(event.keyCode, this);" onchange="return newAjaxCall();"/></td></tr>
              <tr style="height: 10px;"></tr>
              <tr class="label"><td id="clientaddress1label" align="right">Client Address1*:</td><td><input type="text"  name="clientAddress1"  style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;" maxlength="30" onblur="clientAddress1Validation();"onkeyup = "CheckFirstChar(event.keyCode, this);clientAddress1Validation();" onkeydown = "return CheckFirstChar(event.keyCode, this);"/></td></tr>
              <tr style="height: 10px;"></tr>
              <tr class="label"><td id="clientaddress2label" align="right">Client Address2:</td><td><input type="text"  name="clientAddress2"  style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;" maxlength="30" onblur="clientAddress2Validation();"onkeyup = "CheckFirstChar(event.keyCode, this);clientAddress2Validation();" onkeydown = "return CheckFirstChar(event.keyCode, this);"/></td></tr>
              <tr style="height: 10px;"></tr>
              ...
              <tr style="height: 10px;"></tr>
              <tr class="label"><td id="contactPersonlabel" align="right">Contact Person*:</td><td><input type="text"  name="contactPerson"  style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;" maxlength="30" onblur="contactPersonValidation();"onkeyup = "CheckFirstChar(event.keyCode, this);contactPersonValidation();" onkeydown = "return CheckFirstChar(event.keyCode, this);"/></td></tr>
              <tr style="height: 10px;"></tr>
              ...
              <tr style="height: 10px;"></tr>
              <tr class="label"><td id="contactEmaillabel" align="right" >Contact Email*:</td><td><input type="text"  name="contactEmail"  style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;" maxlength="30" onblur="contactEmailValidation();"onkeyup = "CheckFirstChar(event.keyCode, this);contactEmailValidation();" onkeydown = "return CheckFirstChar(event.keyCode, this);"/></td></tr>
