<%--
    Document   : campaigncreation
    Created on : 5 Jun, 2014, 9:41:54 AM
    Author     : murthyk
--%>
...
<html>
    <head>
       ...
       <script type="text/javascript" language="javascript">
        ...
        $.post('/QuickKlix/campaignCreationExist.action', { data: campaignsName}, responseData, "text");
        } }
    ...
    <body class="body_page">
      ...
      <div style="margin-top:-38px;margin-left: 14px;position: absolute;"><font style="font: bold 1.6em/1em Cambria;color: white;">New Campaign</font></div>

        <form action="campaignCreationDetailsSaving" name="campaignFormName" id="campaignFormId" onsubmit="return addProducts();" >
          <div style="margin-left: 10px;"><br/>

          <table style="margin-left: 25px;margin-top:13px;">
                 <tr class="label"><td id="clientId" align="right">Client Name*:</td>
                 <td><s:select list="campaignClientList" name="campaignClientName" cssStyle="margin-top:-26px;position:absolute;height:25px;width:230px; background-color: white;border-color: #f4f4f4;border-radius: 5px;box-shadow: 3px 3px 1px gray;border: solid 1px #595959;" onblur="campaignClientNameValidation();" onkeyup = "campaignClientNameValidation();" headerKey=""  headerValue="--------Select Client Name--------"/></td>
                 <td></td><td> <a href="newCampaignClientCreation.action" style="text-decoration: none;"><button type="button" onMouseOver="this.style.color='#00a9f1';document.getElementById('AddNewFormImg1').src='/QuickKlix/images/SSImgs/AddNewFormSmallMOImg.png';" onMouseOut="this.style.color='white';document.getElementById('AddNewFormImg1').src='/QuickKlix/images/SSImgs/AddNewFormSmallImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; margin-left: 0px; height: 28px;color: white; font: bold 1.0em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;position:absolute;margin-left:250px;margin-top:-33px;"><img id="AddNewFormImg1" src="/QuickKlix/images/SSImgs/AddNewFormSmallImg.png" /><font style="top: -2px;position: relative;">&nbsp;ADD NEW CLIENT</font></button></a> </td></tr>
                 ...
                 <tr><td></td><td><select name="campaignProductsList" id="existingProductId" onclick="removeProductsInSelectBox();" size="4" style="display: none;margin-top: 13px;width:230px; border-radius: 5px;box-shadow: 3px 3px 1px gray;border: solid 1px #595959;  padding: 5px" ></select></td>
