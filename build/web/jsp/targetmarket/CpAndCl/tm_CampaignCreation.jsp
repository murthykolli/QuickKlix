<%--
    Document   : mediaplanCampaignCreation
    Created on : 30 Jun, 2014, 3:14:52 PM
    Author     : murthyk
--%>
...
<html>
    <head>
       ...
       <script src="/QuickKlix/scripts/jquery.ui.core.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            var existedName  = "<s:property value="campaignNameAlreadyExist"/>";
	    ...
	    $("#txtFromDate").datepicker("option","maxDate", selected)
          ...
          function validation(){
           ...
           var campaignClientName=document.campaignFormName.tmsClientName.value;
           var campaignName=document.campaignFormName.tmsCampaignName.value;
       ...
       <script type="text/javascript" language="javascript">
        ...
        if(document.campaignFormName.tmsCampaignName.value != ''){
        var campaignsName = document.campaignFormName.tmsCampaignName.value;
    ...
    <body class="body_page">
      ...
      <div style="margin-top:-38px;margin-left: 14px;position: absolute;"><font style="font: bold 1.6em/1em Cambria;color: white;">New Campaign</font></div>
        ...
        <form action="tmCampaignDetailsSaving" name="campaignFormName" id="campaignFormId" onsubmit="return addProducts();" >
          <div style="margin-left: 10px;"><br/>

          <table style="margin-left: 25px;margin-top:13px;">
                 <tr class="label"><td id="clientId" align="right">Client Name*:</td>
                 <td><s:textfield name="tmsClientName" readonly="true" cssStyle="margin-top:-26px;position:absolute;height:25px;width:230px; background-color: white;border-color: #f4f4f4;border-radius: 5px;box-shadow: 3px 3px 1px gray;border: solid 1px #595959;"/>
                 </td></tr>
                 <tr style="height: 10px;"></tr>
                 <tr class="label"><td id="campaignId" align="right">Campaign Name*:</td><td>  <input type="text" name="tmsCampaignName" style="height:25px;width:230px;border-radius: 5px;box-shadow: 3px 3px 1px gray;border: solid 1px #595959;" onblur="campaignNameValidation();" onkeyup = "CheckFirstChar(event.keyCode, this);campaignNameValidation();" onkeydown = "return CheckFirstChar(event.keyCode, this);" onchange="return newAjaxCall();"/></td></tr>
                 <tr style="height: 10px;"></tr>
                 ...
                 <td align="right"> <button id="removeButtonId" type="button" onMouseOver="this.style.color='#00a9f1';document.getElementById('RemoveButtonImg1').src='/QuickKlix/images/SSImgs/RemoveButtonMOImg.png';" onMouseOut="this.style.color='white';document.getElementById('RemoveButtonImg1').src='/QuickKlix/images/SSImgs/RemoveButtonImg.png';" style="display: none;background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; margin-left: 0px; color: white; height: 28px; font: bold 1.0em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;position:absolute;margin-left: -58px; margin-top: -30px;" onclick="removeProducts()"><img id="RemoveButtonImg1" src="/QuickKlix/images/SSImgs/RemoveButtonImg.png" /><font style="top: -2px;position: relative;">&nbsp;REMOVE</font></button></td></tr>
