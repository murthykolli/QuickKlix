...
<html>
    ...
    <script type="text/javascript">
        ...
        var myCookie = new Cookie();
        var newTmDime = "<s:property value="newTmDimention"/>";
        if(newTmDime == "NewTmDimentionCreation"){
...
//        } 
    ...
    <s:form action="tmDetailsSaving" name="tmFormName">            
        ...
        <div style=" margin-top: 20px">
            ...
            <tr>
                ...
                <td id="next"><button type="submit" name="method:targetMarketCreation" onclick="return saveTMSelected()" onMouseOver="this.style.color='#00a9f1';document.getElementById('SmallImgButton3').src='/QuickKlix/images/SSImgs/MapNextMOImg.png';" onMouseOut="this.style.color='white';document.getElementById('SmallImgButton3').src='/QuickKlix/images/SSImgs/MapNextImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white;height: 28px; font: bold 1.0em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;margin-left: 470px"><font style="top: -3px;left: 0px;position: relative;"> NEXT &nbsp;</font><img id="SmallImgButton3" src="/QuickKlix/images/SSImgs/MapNextImg.png" style="top: -1px;left: 0px;position: relative;" /></button></td>
