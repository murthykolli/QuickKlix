<%-- 
    Document   : clientsaving
    Created on : 5 Jun, 2014, 9:45:34 AM
    Author     : murthyk
--%>
...
function Pager(tableName, itemsPerPage) {
 ...
 function onLoadProperties()
    ...
    function changeColor(chk){
                if(chk.checked==true || document.clientFormName.combinationalName[chk].checked==true){
                    var i;
            ...
            function highlightTableRows(tableId) {
                ...
                for (var i=0; i < rows.length; i++) {
                    rows[i].onmouseover = function() {
                        ...
                        var cell=row.getElementsByTagName('td');
                        if((rows.length==2 && document.clientFormName.combinationalName.checked==false) || (document.clientFormName.combinationalName[j-1].checked==false)){
                    ...
                    rows[i].onclick=function(){
                        ...
                        if(rows.length==2){
                            ...
                            document.clientFormName.combinationalName.checked=true;

                        }
                        else{
                            document.clientFormName.combinationalName[l-1].checked=true;
                            changeColor(l-1);
                            } };}  }
       ...
       <script defer="pager">
        ...
        if("<s:property value="capaignExisted"/>" == "CampaignExisted"){
        alert("This client has campaigns, so delete campaigns first.");
        }
        });
        </script>
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">My Account</font></div><br/>
        ...
        <table style="margin-left: 24px;margin-top:31px;position: absolute;">
            <tr><td style="border-bottom: 27px solid #f1f1f1;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="manageCampaignsSaving.action" title="Campaigns Saving" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="#6f6e6e" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='#6f6e6e';" ><b>&nbsp;Campaigns Saving&nbsp;<font style="color: #00A9F1;font: bold 1.0em/1.25em Cambria;"> - <s:property value="campaignCount"/>&nbsp;</font></b></font></a> </td>
                <td style="border-bottom: 27px solid #7e7e7e;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="manageClientsSaving.action" title="Clients Saving" style="position: relative;top:25px;cursor: pointer;text-decoration: none;" ><font color="white" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='white';"><b>&nbsp;Clients Saving&nbsp;<font style="color: #00A9F1;font: bold 1.0em/1.25em Cambria;"> - <s:property value="clientCount"/>&nbsp;</font></b></font></a> </td>
            </tr>
        </table>
     ...
     <s:form  action="clientManagementSaving" name="clientFormName" id="clientFormId">


                <table>
                    <tr>
                        <td width="880px" align="right">
                            <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total&nbsp;clients&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
                        </td>
                    </tr>
                </table>
                ...
                <display:table  id="insured_list"  class="tablesorter" name="clientDetailsTakeFromDBToManagement">
                    <display:column headerClass="sortDisabled">
                        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="combinationalName" value="${insured_list.clientName}, ${insured_list.cityName}"/>
                    </display:column>
                    <display:column property ="clientName" title="Client Name"/>
                    <display:column property ="cityName" title="City" />
                    <display:column property ="stateName" title="State Name" />
                    <display:column property ="countryName" title="Country Name" />
                    <display:column property ="zipCode" title="Zip Code" />
                    <display:column property ="contactPerson" title="Contact Person" />
                    <display:column property ="contactPhoneNo" title="Contact Phone No" />
                    <display:column property ="contactEmail" title="Contact Email" />
        ...
        //alert("ON LOAD");
        var count="<s:property value="clientFormsCount"/>";
        // document.getElementById("cmdPrevId").style.display = "none";
       ...
       approve();
            ...
            function deleteForm(){
                ...
                for(var k=0; k < document.clientFormName.combinationalName.length; k++)
                {
                    if(document.clientFormName.combinationalName[k].checked){
                        combinationalNames=document.clientFormName.combinationalName[k].value;
                    }
                }
                if(document.clientFormName.combinationalName.checked){
                    combinationalNames=document.clientFormName.combinationalName.value;
                  }
                if(combinationalNames != ""){
                    combinationalNames = combinationalNames.split(", ");
                    var where_to= confirm("Do you want to delete Client "+combinationalNames[0]+" ?");
                    if (where_to)
                    {
                        return true;
                    }
