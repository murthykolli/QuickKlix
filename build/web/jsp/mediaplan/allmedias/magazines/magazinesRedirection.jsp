...
<html>
  ...
  $(document).ready(function(){
    ...
    <div style="margin-top:38px;margin-left: 54px;position: absolute;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Magazines</font></div><br/>
    ...
    <td style="border-bottom: 27px solid #f1f1f1;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="mobileAppsRedirection.action" title="Mobile Apps" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="#6f6e6e" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='#6f6e6e';" ><b>&nbsp;Mobile Apps&nbsp;</b></font></a> </td>
     ...
     <div style=" margin-top: 20px;margin-left: 27px;"><font style="font: bold 1.5em/1.25em Cambria; color: #00a9f1;"><a  href="mgselectbycategory.action" style="color:#00a9f1;" onmouseover="this.style.color='blue';" onmouseout="this.style.color='#00a9f1';"><b><u>Select by Category</u></b></a></font><font style="font: bold 1.5em/1.25em Cambria; color: #595959;"><b>&nbsp;&nbsp;or&nbsp;&nbsp;</b></font><font style="font: bold 1.5em/1.25em Cambria; color: #00a9f1;"><a href="top100magazinescirculation.action" style="color:#00a9f1;" onmouseover="this.style.color='blue';" onmouseout="this.style.color='#00a9f1';"><b><u>Select by Circulation - Top 100 Magazines</u></b></a></font></div><br/><br/>
     <img src="/QuickKlix/images/mediaplan/magazine.png" style="margin-left: 695px;margin-top: -30px;" alt="Magazines"/>
     <div style=" margin-top: -255px;">    
     <p style="color: #242424;margin-left: 27px;margin-top: -10px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;">When searching for magazines of a specific genre, browsing magazines by category will allow you to select magazines from a large list within that category.</p>
     <p style="color: #242424;margin-left: 27px;margin-top: 20px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;">Selecting magazines according to circulation will allow you to choose magazines with the highest numbers in distribution.</p>
     <p style="color: #242424;margin-left: 27px;margin-top: 20px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;">If you would like to select magazines for your media plan using both methods, select one method first, make your selections using that method and save them to your media plan. Then you can use the second method to make more selections. </p>
