...
<html>
  ...
  $(document).ready(function(){
    ...
    <div style="margin-top:38px;margin-left: 54px;position: absolute;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Television</font></div><br/>
    ...
    <td style="border-bottom: 27px solid #7e7e7e;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="televisionRedirection.action" title="Television" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="white" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='white';" ><b>&nbsp;TV&nbsp;</b></font></a> </td>
    ...
    <td style="border-bottom: 27px solid #f1f1f1;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="mobileAppsRedirection.action" title="Mobile Apps" style="position: relative;top:25px;cursor: pointer;text-decoration: none;"><font color="#6f6e6e" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='#6f6e6e';" ><b>&nbsp;Mobile Apps&nbsp;</b></font></a> </td>
     ...
     <div style=" margin-top: 20px;margin-left: 27px;"><font style="font: bold 1.5em/1.25em Cambria; color: #00a9f1;"><a  href="tvSelectByLocation.action" style="color:#00a9f1;" onmouseover="this.style.color='blue';" onmouseout="this.style.color='#00a9f1';"><b><u>Select by Location</u></b></a></font><font style="font: bold 1.5em/1.25em Cambria; color: #595959;"><b>&nbsp;&nbsp;or&nbsp;&nbsp;</b></font><font style="font: bold 1.5em/1.25em Cambria; color: #00a9f1;"><a href="tvSelectByNetwork.action" style="color:#00a9f1;" onmouseover="this.style.color='blue';" onmouseout="this.style.color='#00a9f1';"><b><u>Select by Network</u></b></a></font></div><br/><br/>
     <img src="/QuickKlix/images/mediaplan/tvimage.png" style="margin-left: 700px;margin-top: -45px;" alt="Television"/> 
     <div style=" margin-top: -266px;">
     <p style="color: #242424;margin-left: 27px;margin-top: -15px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;">Using our interactive map will allow you to narrow or widen your station search from as wide as the entire United States or as narrow as small town America.</p>

     <p style="color: #242424;margin-left: 27px;margin-top: 15px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;">Selecting television stations according to network will allow you to choose advertising slots during programs that cater to a specific audience.</p> 

     <p style="color: #242424;margin-left: 27px;margin-top: 15px;width: 620px;text-align: justify;font: 1.1em/1.25em sans-serif;"> If you would like to select television stations for your media plan using both methods, select one method first, make your selections using that method and save them to your media plan. Then you can use the second method to make more selections.</p> 
