...
//    element.innerHTML = pagerHtml;
    ...
    if (chk.checked == true || document.television.combinationalName[chk].checked == true) {
    var i;
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Television</font></div><br/>
     ...
     <div style=" min-height: 250px;">
      ...
      <s:form  action="televisionManagement" name="television" id="television">
        <table> <tr> <td width="880px" align="right">
        <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total channels&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
        </td> </tr> </table>
        ...
        <display:table  id="insured_list"  class="tablesorter" name="tvDataListTakeFromDB" style="width:860px;">
   ...
   <br/><br/><br/><br/><br/><br/>
    ...
    televisionNames=document.television.combinationalName[k].value;
    }
    }
    if(document.television.combinationalName.checked){
    televisionNames=document.television.combinationalName.value;
    }
    if(televisionNames != ""){
    var where_to= confirm("Do you want to delete the Television Station(s)?");
    if (where_to)
    {
    return true;
    }
