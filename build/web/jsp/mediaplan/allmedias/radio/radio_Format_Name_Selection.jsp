<%-- 
    Document   : radio_Format_Name_Selection
    Created on : 17 Jul, 2014, 12:52:46 PM
    Author     : anusha
--%>
...
<html>
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Radio Name - <font color="#00a9f1">Radio Format <s:property value="radioDisplayFormat"/></font></font></div><br/>
  <form name="radio" action="radioFormatStationSelection.action"  method="post">
  ...
  <%
            if (null != session.getAttribute("Radio_Format_Names_Map")) {
              Map sortedMap = (Map) session.getAttribute("Radio_Format_Names_Map");
