<%-- 
    Document   : radio_Format_ContactInfo_Selection
    Created on : 17 Jul, 2014, 1:02:05 PM
    Author     : anusha
--%>
...
<html>
    ...
    this.showRecords = function(from, to) {
        ...
        document.radio.selectall.checked=false;
    ...
    this.showPageNav = function(pagerName, positionId) {
     ...
     var element = document.getElementById(positionId);
      var pagerHtml ='<table border="0" id="navigation" align="left"> <tr><td align="left" width="130">';
        ...
        var cell=row.getElementsByTagName('td');
        if((rows.length==2 && document.radio.combinationalName.checked==false) || (document.radio.combinationalName[j-1].checked==false)){
        ...
        var cell = row.getElementsByTagName('td');
        if(document.radio.combinationalName.checked == false){              
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "#00a9f1";
        cell[k].style.color = "white";
        }        
        ...
        if(document.radio.combinationalName[l - 1].checked == false){
        document.radio.combinationalName[l - 1].checked = true;
        }
        else{
        document.radio.combinationalName[l - 1].checked = false;
        changeColor(l - 1);
        } }; }  }
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Radio</font></font></div><br/>
  <div style="margin-left:20px;">
  <s:form id="radio" name="radio" action="radioFormatContactInfoSaving">

      <table border="0"  style="margin-left: 30px;width:870px;">
          <tr>                   
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total&nbsp;selected radio stations&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="radioContactInfo" style="width:890px;">
              ...
              <display:column property ="radioStationName" title="Radio Station Name"/>
              <display:column property ="radioBand" title="Band" />
              <display:column property ="radioCity" title="City" />
              <display:column property ="radioState" title="State" />
              <display:column property ="radioContactPerson" title="Contact Person" />
              <display:column property ="radioRank" title="Rank" />
              <display:column property ="radioFormat" title="Format" />
              <display:column property ="radioPhoneNumber" title="Phone No" />
              <display:column property ="radioFaxNumber" title="Fax No" />
              <display:column property ="radioWebsite" title="Website" />
              <display:column property ="radioEmail" title="Email" />
          </display:table>
     ...
     <div align="center" style="margin-top: 50px;margin-left: 200px;">
         ...
         <table style="margin-left: 565px;margin-top: -10px;position: absolute">
             <tr><td><button type="submit" name="method:radioSaving" onclick="return radioStationSelection();" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" /> <font style="top: -3px;position: relative;">SAVE</font></button></td></tr>
         </table>
         </div>
        ...
        var count=<s:property value="radioCount"/>;
        ...
        function radioStationSelection(){
         ...
         for(var k=0; k < document.radio.combinationalName.length; k++)
          ...
          if(document.radio.combinationalName[k].checked){
           selectedRadio=document.radio.combinationalName[k].value;
          }
        }
        if(document.radio.combinationalName.checked){
         selectedRadio=document.radio.combinationalName.value;
         }
         if(selectedRadio == ""){
