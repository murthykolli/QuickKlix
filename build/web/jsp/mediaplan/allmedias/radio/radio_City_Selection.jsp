<%-- 
    Document   : radio_City_Selection
    Created on : 16 Jul, 2014, 11:47:55 AM
    Author     : anusha
--%>
...
<html>
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by City - <font color="#00a9f1">Radio</font></font></div><br/>
  <form name="radioCity" action="radioSelectByCity.action" method="post">
  ...
  <div style="margin-top:-13px;">
        <%   
            if(session.getAttribute("Radio_City_Map")!=null)
            {
                Map sortedMap = (Map)session.getAttribute("Radio_City_Map");
  ...
  <div align="center" style="margin-top: 15px;margin-left: 0px;">
      ...
      <table style="margin-left: 808px;margin-top: 0px;position: absolute">
          <tr><td><button type="submit" name="method:radioNamesByCity"  onclick="return citySelection();" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/TextPointerWMOImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/TextPointerImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 36px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"><font style="top: -2px;position: relative;">NEXT</font> <img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/TextPointerImg.png" style="position: relative;top: 1px;"/></button></td></tr>
      </table>
  </div>    
        </form>
  <br/><br/><br/><br/><br/><br/>
