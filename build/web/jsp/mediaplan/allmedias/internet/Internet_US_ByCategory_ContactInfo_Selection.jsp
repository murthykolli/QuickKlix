<%-- 
    Document   : Internet_US_ByCategory_ContactInfo_Selection
    Created on : 23 Jul, 2014, 12:30:59 PM
    Author     : anusha
--%>
...
<html>
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Top Internet Sites in the US by Category</font></font></div><br>
  <div style="margin-left:20px;">
  <s:form id="internet" name="internet" action="USInternetCategoryContactInfoSaving">
