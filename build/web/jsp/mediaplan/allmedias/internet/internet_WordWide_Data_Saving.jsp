<%-- 
    Document   : internet_WordWide_Data_Saving
    Created on : 23 Jul, 2014, 11:17:13 AM
    Author     : anusha
--%>
...
//        element.innerHTML = pagerHtml;
        ...
        function changeColor(chk) {
            if (chk.checked == true || document.internet.combinationalName[chk].checked == true) {
                var i;
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
     ...
     <div style=" min-height: 250px;">
      ...
      <s:form  action="manageInternetWorldWideSaving" name="internet" id="internet">

               <table> <tr> <td width="880" align="right">
                 <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total internet websites&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
               </td> </tr> </table>
              ...
              <div style="margin-left: 0px;width: 902px;margin-top: -15px;">
                ...
                <display:table  id="insured_list"  class="tablesorter" name="internetSitesListTakeFromDB" style="width:860px;">
            ...
            function deleteForm(){
                ...
                for(var k=0; k < document.internet.combinationalName.length; k++)
                {
                    if(document.internet.combinationalName[k].checked){
                        mediaName=document.internet.combinationalName[k].value;
                    }
                }
                if(document.internet.combinationalName.checked){
                    mediaName=document.internet.combinationalName.value;
                  }
                if(mediaName != ""){
                    var where_to= confirm("Do you want to delete the Internet Website(s)?");
                    if (where_to)
                    {
                        return true;
                    }
