...
<html>
    ...
    document.mAppsFormName.selectall.checked=false;
    ...
    function highlightTableRows(tableId) {
        ...
        var cell=row.getElementsByTagName('td');
        if((rows.length==2 && document.mAppsFormName.combinationalName.checked==false) || (document.mAppsFormName.combinationalName[j-1].checked==false)){
        ...
        var cell = row.getElementsByTagName('td');
        if(document.mAppsFormName.combinationalName.checked == false){              
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "#00a9f1";
        cell[k].style.color = "white";
        }        
        document.mAppsFormName.combinationalName.checked = true;
        } else{
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "";
        cell[k].style.color = "black";
        }
        document.mAppsFormName.combinationalName.checked = false;    
        } }
    
        if(document.mAppsFormName.combinationalName[l - 1].checked == false){
        document.mAppsFormName.combinationalName[l - 1].checked = true;
        }
        else{
        document.mAppsFormName.combinationalName[l - 1].checked = false;
        changeColor(l - 1);
        } }; }  }
  ...
  <body class="body_page">
    ...
    <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Mobile Apps</font></font></div><br/>
    <div style="margin-left:20px;">
    <s:form id="mAppsFormName" name="mAppsFormName" action="mobileAppContactInfoSaving">
      <table border="0" width="870px" style="margin-left: 30px;">
          <tr>                   
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total selected apps&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
        ...
        <display:table  id="insured_list"  class="tablesorter" name="mobileAppsContactInfoList" style="width:890px;">
          ...
          <input type="checkbox" style=" cursor: pointer;" onclick="changeColor(this);" name="combinationalName" value="${insured_list.mobileAppsId}"/>
          </display:column>
          <display:column property ="mobileAppsName" title="Mobile Apps Name"/>
          <display:column property ="operatingSystemName" title="Operating System" />
          <display:column property ="typeOfMobileApp" title="Type of App" />
          <display:column property ="mobileAppsCategory" title="Category" />
          <display:column property ="mobileAppsVersion" title="Version" />
          <display:column property ="mobileAppsDeveloper" title="Developer" />
          <display:column property ="mobileAppsDownload" title="No.of Downloads" />
          <display:column property ="mobileAppsEmail" title="Email" />
          <display:column property ="mobileAppsPhoneNo" title="Phone" />
          <display:column property ="mobileAppsFaxNo" title="Fax" />
       </display:table>
      ...
      <div align="center" style="margin-top: 50px;margin-left: 200px;">
         <table style="margin-left: -165px;margin-top:-10px;position: absolute">
             <tr><td><button type="submit" name="method:mobAppBackMove" onMouseOver="this.style.color='#00a9f1';document.getElementById('BackButtonImg1').src='/QuickKlix/images/SSImgs/TextPointerWMOPreviousImg.png';" onMouseOut="this.style.color='white';document.getElementById('BackButtonImg1').src='/QuickKlix/images/SSImgs/TextPointerPreViousImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"><img id="BackButtonImg1" src="/QuickKlix/images/SSImgs/TextPointerPreViousImg.png" /> <font style="top: -3px;position: relative;">BACK</font></button></td></tr>
         </table>
                      
         <table style="margin-left: 565px;margin-top: -10px;position: absolute">
             <tr><td><button type="submit" name="method:mobileAppsSaving" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 38px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;"  onclick="return mobilesAppsSelection();"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" /> <font style="top: -3px;position: relative;">SAVE</font></button></td></tr>
         </table>
      </div>
     </s:form>
   <script>
      window.onload = function(){
       ...
       var form=document.getElementById("mAppsFormName");
       if(count=="0"){
      ...
      function mobilesAppsSelection(){
        var selectedApps="";
        for(var k=0; k < document.mAppsFormName.combinationalName.length; k++)
        {
        if(document.mAppsFormName.combinationalName[k].checked){
        selectedApps=document.mAppsFormName.combinationalName[k].value;
        }}
        if(document.mAppsFormName.combinationalName.checked){
        selectedApps=document.mAppsFormName.combinationalName.value;
        }
        if(selectedApps == ""){
        window.alert("Please select at least one apps category.");
        return false;
        }}
    </script>
      </div>  
