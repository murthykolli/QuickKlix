...
<html>
 ...
 <body>
  ...
  <div style="margin-top:20px;margin-left: 40px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Selected Apps Category by Alphabetical order  - </font><font color="#00a9f1" style="font-family: Calibri;font-size: 22px;font-weight: bold;"><s:property value="mobileAppsCategory"/></font></div><br/>
  <form name="mAppFormName" action="mobileAppsNameSelection.action" method="post">
        ...
        <tr><td></td><td><input type="radio" name="appCategoryType"  checked="checked" value="Alphabetical" onClick="operatingsystem_submit('Alphabetical');return false"/>
        <font color="#242234" size="3">
        by Alphabetical order
        </font>
        </td>
        </tr>
        <tr><td></td><td><input type="radio" name="appCategoryType" value="Operating System" onClick="operatingsystem_submit('Operating System');return false"/>
        <font color="#242234" size="3">
    ...
    <div style="margin-top:-30px;">
            <%
            if (null != session.getAttribute("Mobile_Category_In_Session")) {
            Map sortedMap = (Map) session.getAttribute("Mobile_Category_In_Session");
