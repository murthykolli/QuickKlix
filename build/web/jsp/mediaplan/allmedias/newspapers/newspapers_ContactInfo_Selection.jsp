<%--
    ...
    Created on : 4 Jul, 2014, 3:37:44 PM
    Author     : murthyk
--%>
...
<html>
    ...
    this.showRecords = function(from, to) {
        ...
        document.newspaper.selectall.checked=false;
    ...
    this.showPageNav = function(pagerName, positionId) {
     ...
     var element = document.getElementById(positionId);
      var pagerHtml ='<table border="0" id="navigation" align="left"> <tr><td align="left" width="130">';
        ...
        var cell=row.getElementsByTagName('td');
        if((rows.length==2 && document.newspaper.combinationalName.checked==false) || (document.newspaper.combinationalName[j-1].checked==false)){
        ...
        var cell = row.getElementsByTagName('td');
        if(document.newspaper.combinationalName.checked == false){              
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "#00a9f1";
        cell[k].style.color = "white";
        }        
        document.newspaper.combinationalName.checked = true;
        } else{
        for (var k = 0; k < cell.length; k++) {
        cell[k].style.backgroundColor = "";
        cell[k].style.color = "black";
        }
        document.newspaper.combinationalName.checked = false;    
        } }
    
        if(document.newspaper.combinationalName[l - 1].checked == false){
        document.newspaper.combinationalName[l - 1].checked = true;
        }
        else{
        document.newspaper.combinationalName[l - 1].checked = false;
        changeColor(l - 1);
        } }; }  }
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Newspapers</font></font></div><br/>
  <div style="margin-left:20px;">
  <s:form id="newspaper" name="newspaper" action="npContactInfoSaving">

      <table border="0" width="870px" style="margin-left: 30px;">
          <tr>
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total&nbsp;selected newspapers&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="newspapersContactInfo" style="width:890px;">
              ...
              <display:column property ="newspaperName" title="Newspaper Name"/>
              <display:column property ="npCity" title="City" />
              <display:column property ="npState" title="State" />
              <display:column property ="npCirculation" title="Circulation" />
              <display:column property ="npContactPerson" title="Contact Person" />
              <display:column property ="npPhoneNumber" title="Phone No" />
              <display:column property ="npFaxNumber" title="Fax No" />
              <display:column property ="npWebsite" title="Website" />
              <display:column property ="npEmail" title="Email" />
          </display:table>
        ...
        pager.showPage(1);
         ...
         <table style="margin-left: 10px;margin-top:0px;position: absolute">
         ...
         <table style="margin-left: 780px;margin-top: -10px;position: absolute">
             <tr><td><button type="submit" name="method:newspapersSaving" onMouseOver="this.style.color='#00a9f1';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerWhiteImg.png';" onMouseOut="this.style.color='white';document.getElementById('NextButtonImg1').src='/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png';" style="background: #595959;border-radius: 7px;cursor: pointer; border: 1px solid #595959; color: white; height: 36px; font: bold 1.4em/1em Verdana,Geneva,Arial,Helvetica,sans-serif;box-shadow: 3px 3px 1px #999999;" onclick="return newspaperSelection();"><img id="NextButtonImg1" src="/QuickKlix/images/SSImgs/SaveTextPointerBlueImg.png" style="position: relative;top: 1px;" /> <font style="top: -2px;position: relative;">SAVE</font></button></td></tr>
         </table>
         </div>
       ...
       ele.appendChild(countele);
        ...
        function newspaperSelection(){
         ...
         for(var k=0; k < document.newspaper.combinationalName.length; k++)
          {
          if(document.newspaper.combinationalName[k].checked){
           selectedNewspaper=document.newspaper.combinationalName[k].value;
          }
        }
        if(document.newspaper.combinationalName.checked){
         selectedNewspaper=document.newspaper.combinationalName.value;
         }
