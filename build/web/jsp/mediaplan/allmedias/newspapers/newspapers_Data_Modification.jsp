<%-- 
    Document   : newspapers_Modification
    Created on : 21 Jul, 2014, 1:04:13 PM
    Author     : anusha
--%>
...
<html>
  ...
  <s:form id="newspaper" name="newspaper" action="newspaperModification">

      <table border="0" style="margin-left: 30px;width: 870px;">
          <tr>
              <td>  </td>
