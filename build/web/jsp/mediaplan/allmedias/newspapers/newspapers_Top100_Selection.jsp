<%-- 
    Document   : newspapers_Top100_Selection
...
<html>
  ...
  <div style="margin-top:20px;margin-left: 30px;"><font style="font-family: Calibri;font-size: 22px;font-weight: bold;color:#6f6d6d;">Select by Contact Info - <font color="#00a9f1">Top 100 Newspapers</font></font></div><br/>
  <div style="margin-left:20px;">
  <s:form id="newspaper" name="newspaper" action="npTop100ContactInfoSaving">

      <table border="0" width="870px" style="margin-left: 30px;">
          <tr>
              <td>  </td>
              <td colspan="3" align="right"><b><font style="font: bold 1em/0.25em sans-serif;" color="#00a9f1">Total&nbsp;newspapers&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></b></td>
          </tr>
      </table>
      ...
      <div style="margin-top:-8px;">
          ...
          <display:table  id="insured_list"  class="tablesorter" name="newspapersTop100ContactInfo" style="width:890px;">
        ...
        pager.showPage(1);
         ...
         <table style="margin-left: 10px;margin-top:-10px;position: absolute">
