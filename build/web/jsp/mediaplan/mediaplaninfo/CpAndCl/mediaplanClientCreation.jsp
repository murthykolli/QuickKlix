...
<html>
       ...
       <script>
          window.onload=function(){
           ...
           function validation(){
            ...
            var clientName=document.clientFormName.mpClientName.value;
  ...
  function numeralsOnly(evt) {
   ...
   return true;
        ...
        if(document.clientFormName.mpClientName.value != ''){
        var clientsName = document.clientFormName.mpClientName.value;
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 520px;height: auto;border-radius: 30px 30px 0 0;"><br/>
     ...
     <div style="margin-top:-38px;margin-left: 14px;position: absolute;"><font style="font: bold 1.6em/1em Cambria;color: white;">New Client</font></div>
            ...
            <form action="mpClientDetailsSaving" name="clientFormName" id="clientFormId">
            <div style="margin-left: 10px;"><br/>
             <table style="margin-left: 25px;margin-top:13px;">
                 <tr class="label"><td id="clientnamelabel" align="right">Client Name*:</td><td> <input type="text"  name="mpClientName" style="width: 235px;height:25px;border-radius: 5px;box-shadow: 3px 3px 1px #6a6a6a;border: solid 1px #595959;"  maxlength="60" onblur="clientNameValidation();" onkeyup = "CheckFirstChar(event.keyCode, this);clientNameValidation();" onkeydown = "return CheckFirstChar(event.keyCode, this);" onchange="return newAjaxCall();"/></td></tr>
