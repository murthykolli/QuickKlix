<%-- 
    Document   : mediasSelection
    Created on : 2 Jul, 2014, 3:24:17 PM
    Author     : murthyk
--%>
...
<html>
  ...
  function Pager(tableName, itemsPerPage) {
     ...
     var element = document.getElementById(positionId);
      var pagerHtml ='<table border="0" id="navigation" align="left"> <tr><td align="left" width="130">';
        ...
        function changeColor(chk) {
            if (chk.checked == true || document.allMediasFormName.combinationalName[chk].checked == true) {
                var i;
        ...
        function highlightTableRows(tableId) {
            ...
            for (var i = 1; i < rows.length; i++) {
                rows[i].onmouseover = function() {
                    ...
                    var cell = row.getElementsByTagName('td');
                    if ((rows.length == 2 && document.allMediasFormName.combinationalName.checked == false) || (document.allMediasFormName.combinationalName[j - 1].checked == false)) {
                ...
                rows[i].onclick = function() {
                    ...
                    if (rows.length == 2) {
                        ...
                        document.allMediasFormName.combinationalName.checked = true;

                    }
                    else {
                        document.allMediasFormName.combinationalName[l - 1].checked = true;
                        changeColor(l - 1);
                    } }; } }
    ...
    <div style="background-color: white;width: 950px;margin-top: 30px;margin-left: 10px;min-height: 400px;height: auto;border-radius: 30px 30px 0 0;"><br/>
       ...
       <div style="margin-top:38px;margin-left: 54px;position: absolute;font-family: Cambria;"><font style="font: bold 1.45em/1em Cambria;color:#595959;">Selected Medias</font></div><br/>

        <table style="margin-left: 24px;margin-top:31px;position: absolute;">
            <tr><td style="border-bottom: 27px solid #7e7e7e;border-left: 15px solid transparent;border-right: 15px solid transparent;white-space: nowrap;"> <a href="allMediasDataSaving.action" title="All Medias" style="position: relative;top:25px;cursor: pointer;text-decoration: none;" ><font color="white" style="font: bold 1.15em/1.25em Cambria;" onMouseOver="this.style.color='#00a9f1';" onMouseOut="this.style.color='white';"><b>&nbsp;All Medias&nbsp;</b></font></a> </td>
     ...
     <div style=" min-height: 250px;">
      ...
      <s:form  action="allMediasSelection" name="allMediasFormName" id="allMediasFormId">

               <table> <tr> <td width="880px" align="right">
                 <div  style=" margin-top: 0px;margin-left: 0px;"> <font style="font-size: 14px;font-weight:bold;" color="#00a9f1">Total medias&nbsp;:&nbsp;<span id="displayCount" style="color: #595959;"></span></font></div>
               </td> </tr> </table>
              ...
              <div style="margin-left: 0px;width: 902px;margin-top: -15px;">
                ...
                <display:table  id="insured_list"  class="tablesorter" name="allMediasListTakeFromDB" style="width:860px;">
                    <display:column headerClass="sortDisabled">
                        <input type="radio" style=" cursor: pointer;" onclick="changeColor(this);" name="combinationalName" value="${insured_list.allMediaIds},&,${insured_list.mediaType}"/>
                    </display:column>
                    ...
                    <display:column property ="mediasCount" title="Count" />
     ...
     <script>
        ...
        var count=<s:property value="npCount"/>;
       ...
       var radList = document.getElementsByName("newspaperName");
       for (var i = 0; i < radList.length; i++) {
       if(radList[i].checked) radList[i].checked = false;
       }
       count=<s:property value="mediaNamesCount"/>;
       var form=document.getElementById("allMediasFormId");
       if(count=="0"){
       ...
       ele.appendChild(countele);
            ...
            function deleteForm(){
                ...
                for(var k=0; k < document.allMediasFormName.combinationalName.length; k++)
                {
                    if(document.allMediasFormName.combinationalName[k].checked){
                        combinationalNames=document.allMediasFormName.combinationalName[k].value;
                    }
                }
                if(document.allMediasFormName.combinationalName.checked){
                    combinationalNames=document.allMediasFormName.combinationalName.value;
                  }combinationalNames=combinationalNames.split(",&,")
                if(combinationalNames != ""){
                    var where_to= confirm("Do you want to delete "+combinationalNames[1]+" ?");
                    if (where_to)
                    {
                        return true;
                    }
