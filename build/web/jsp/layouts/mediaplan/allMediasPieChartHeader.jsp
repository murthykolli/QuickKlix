<%-- 
    Document   : allMediasPieChartHeader
    Created on : 11 Aug, 2014, 11:24:20 AM
    Author     : anusha
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link type="text/css" rel="stylesheet" href="/QuickKlix/CSS/pichartReportscss.css" />
        ...
        $(document).ready(function(){
               ...
               if(allMediaRed > 0){               
               document.getElementById("AllMediaRedirection").style.display='block';
               }
          });
        </script>
...
<body>
    ...
    <div id="quickklix_container" style="width: 960px;">
    ...
    <li><a href="mediaPlanRedirection.action" class="current">MEDIA PLAN</a>
    <ul class="subMenuMediaPlan">
        ...
        <li class="subMenuText" style="display:none;" id="AllMediaRedirection"><a href="allMediasDataSaving.action" title="Selected Media(s)">Selected Media(s)</a></li>
        <li class="submenuhead" style="color: #00a9f1;"><font><b>PRINT MEDIA</b></font></li><br/>
        <li class="subMenuText"><a href="newspapersRedirection.action" title="Newspapers">Newspapers</a></li><br/>
        <li class="subMenuText"><a href="magazinesRedirection.action" title="Magazines">Magazines</a></li><br/>
        <li class="submenuhead" style="color: #00a9f1;"><font><b>DIGITAL MEDIA</b></font></li><br/>
        <li class="subMenuText"><a href="televisionRedirection.action" title="Television">Television</a></li><br/>
        <li class="subMenuText"><a href="radioRedirection.action" title="Radio">Radio</a></li><br/>
        <li class="subMenuText"><a href="internetRedirection.action" title="Internet">Internet</a></li><br/>
        <li class="subMenuText"><a href="mobileAppsRedirection.action" title="Mobile Apps">Mobile Apps</a></li><br/><br/>
        </ul>
    </ul> </li>
    ...
    <li><a href="analyticsRedirection">ANALYTICS</a>
    </li>
