<%-- 
    Document   : userreportsheader
    Created on : 9 Sep, 2014, 5:17:31 PM
    Author     : murthyk
--%>
...
<body>
    ...
    <li><a href="reportsRedirection.action" class="current">REPORTS</a>
    <ul class="subMenuReports">
        <ul style="float:left;">        
        <li class="submenuhead" style="color: #00a9f1;"><font><b>USER REPORTS</b></font></li><br/>
        <li class="subMenuText"><a href="campaignsperClientReports.action" title="Campaigns per Client">Campaigns per Client</a></li><br/>
        <li class="subMenuText"><a href="budgetperCampaignReports.action" title="Budget per Campaign">Budget per Campaign</a></li><br/>
        <li class="subMenuText"><a href="targetMarketperClientReports.action" title="Target Market per Client">Target Market per Client</a></li><br/>
        <li class="subMenuText"><a href="mediaPlanperClientReports.action" title="Media Plan per Client">Media Plan per Client</a></li><br/>
        <li class="subMenuText"><a href="viewAllUserReports.action" title="View All">View All</a></li><br/>
        <li class="submenuhead" style="color: #00a9f1;"><font><b>CLIENT REPORTS</b></font></li><br/>
        <li class="subMenuText"><a href="clientsperCampaignReports.action" title="Client Reports">Client Reports</a></li><br/><br/>       
        </ul>
    </ul> </li>
