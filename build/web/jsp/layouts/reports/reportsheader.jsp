<%-- 
    ...
    Created on : 3 Jun, 2014, 4:34:55 PM
    Author     : murthyk
--%>
...
<body>
    ...
    <ul class="subMenuReports">
        <ul style="float:left;">
        <li class="subMenuText"><a href="userReportsRedirection.action" title="User Reports">User Reports</a></li><br/>
        <li class="subMenuText"><a href="#" title="Client Reports">Client Reports</a></li><br/>
        </ul>
    </ul> </li>
